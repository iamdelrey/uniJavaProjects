...
public class DrunkardGameLinkedList {
    private LinkedList<Integer> player1Deck;
    private LinkedList<Integer> player2Deck;

    public DrunkardGameLinkedList() {
    ...
    public static void main(String[] args) {
        ...
        DrunkardGameLinkedList game = new DrunkardGameLinkedList();
